...
update_parser_list = [submodules_parser]
...
if __name__ == "__main__":
    ...
    update_parser = action_subparsers.add_parser("update",
                                                  help="update projects submodules")

    update_target_subparser = update_parser.add_subparsers(help="what to update")

    for parser in update_parser_list:
        parser(update_target_subparser)
